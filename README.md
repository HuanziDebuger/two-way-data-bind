...
<p><img width="100%" src="./images/img03.png"></p>
 ...
 <p><img width="100%" src="./images/img04.png"></p>
 <p><img width="100%" src="./images/img05.png"></p>
 首先将该任务分成几个子任务：
...
<p><img width="100%" src="./images/img06.png"></p>
<p><img width="100%" src="./images/img07.png"></p>
五、数据初始化绑定
<p><img width="100%" src="./images/img08.png"></p>
<p><img width="100%" src="./images/img09.png"></p>
<p><img width="100%" src="./images/img10.png"></p>
以上代码实现了任务一，我们可以看到，hello world已经呈现在输入框和文本节点中。
<p><img width="100%" src="./images/img11.png"></p>
六、响应式的数据绑定
...
<p><img width="100%" src="./images/img12.png"></p>
<p><img width="100%" src="./images/img13.png"></p>
任务二也就完成了，text 属性值会与输入框的内容同步变化：
<p><img width="100%" src="./images/img14.png"></p>
...
<p><img width="100%" src="./images/img15.png"></p>
 ...
 八、双向绑定的实现
  ...
  <p><img width="100%" src="./images/img16.png"></p>
   在编译 HTML 过程中，为每个与 data 关联的节点生成一个 Watcher。Watcher 函数中发生了什么呢？
   <p><img width="100%" src="./images/img17.png"></p>
 ...
 <p><img width="100%" src="./images/img18.png"></p>
 <p><img width="100%" src="./images/img19.png"></p>
